...
public class Main {
    ...
    private static void ExportFile() {
        ...
        // File path and name.
        File filePath = new File("C:/Users/user/IdeaProjects/BookingTourismAnalysis");
        ...
        if (filePath.isDirectory()) {
            ...
            try {
                ...
                File filePath2 = new File("C:/Users/user/IdeaProjects/BookingTourismAnalysis/searchesexport.csv");
